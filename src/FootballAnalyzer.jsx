...
const Navbar = ({ activeSport, setActiveSport }) => {
  ...
  const sports = [
    ...
    { name: "Baseball", icon: <GiBaseballBat className="mr-2" /> },
    {
      ...
      icon: <GiAmericanFootballPlayer className="mr-2" />,
    },
  ];
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-8">
              ...
              <motion.div whileHover={{ width: 200 }} className="relative">
                <input
                  type="text"
                  placeholder="Search..."
      ...
      steps.forEach((step, i) => {
        setTimeout(() => {
          ...
          if (step === 100) {
            setTimeout(() => {
              setProcessing(false);
              setOutputVideoURL(videoURL); // ⬅️ Use blob URL for <video> playback
              setActiveTab("Result");
            }, 500);
          }
        }, i * 600);
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0A0E14] to-[#161B22] text-white pt-16">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="text-center mb-20">
          ...
          >
            Transform your game with our AI-powered {activeSport.toLowerCase()}{" "}
            analysis platform. Upload your footage and get professional-level
            insights.
          </motion.p>
        ...
        <section
          id="analysis-section"
          className="bg-[#1E242D] rounded-xl shadow-xl p-6 md:p-8 border border-gray-800"
        >
          <motion.h2
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
                  ...
                  {outputVideoURL ? (
                    <div className="space-y-6">
                      <div className="relative rounded-lg overflow-hidden">
                        <video
                          key={outputVideoURL} // <-- this forces React to remount the video element when URL changes
                          src={outputVideoURL}
                          controls
                          autoPlay
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-[#0D1117] p-4 rounded-lg border border-gray-800">
                          ...
                          <ul className="space-y-2 text-sm">
                            <li className="flex justify-between">
                              <span>Distance Covered:</span> <span>8.2 km</span>
                            </li>
                            <li className="flex justify-between">
                              <span>Top Speed:</span> <span>32.5 km/h</span>
                            </li>
                            <li className="flex justify-between">
                              <span>Pass Accuracy:</span> <span>87%</span>
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="bg-[#0D1117] p-4 rounded-lg border border-gray-800">
                          ...
                          <ul className="space-y-2 text-sm">
                            <li className="flex justify-between">
                              <span>Possession:</span> <span>62%</span>
                            </li>
                            <li className="flex justify-between">
                              <span>Shots on Target:</span> <span>8</span>
                            </li>
                            <li className="flex justify-between">
                              <span>Corners:</span> <span>5</span>
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="bg-[#0D1117] p-4 rounded-lg border border-gray-800">
                          ...
                          <ul className="space-y-2 text-sm">
                            <li className="flex justify-between">
                              <span>Best Chance:</span> <span>72'</span>
                            </li>
                            <li className="flex justify-between">
                              <span>Defensive Error:</span> <span>34'</span>
                            </li>
                            <li className="flex justify-between">
                              <span>Turnover:</span> <span>58'</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className="p-12 text-center border-2 border-dashed border-gray-700 rounded-lg bg-[#0D1117]">
                      ...
                      <p className="text-gray-500 mb-6">
                        Upload and process a {activeSport.toLowerCase()} video
        ...
        <section className="mt-20 text-center">
          ...
          <p className="text-gray-400 mt-4">
            Join thousands of coaches and athletes improving their game
          </p>
        </section>
      </main>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mt-4 text-sm">
                Revolutionizing sports performance through AI-powered analytics.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2023 SportsAnalytics. All rights reserved.
            </p>
